# TODO
Settings: 
- file provider as an appendable list of config items, each with: a type selector (github/local) and some other input as text (root folder, repo name,...)
- Temp file location
- Temp dir size limit
- Shortcut to call the app
